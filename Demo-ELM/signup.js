...
var $author$project$Signup$initialModel = {email: 'Correo Electrónico', loggedIn: false, name: 'Nombre de usuario', password: 'Contraseña'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Registrate')
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Nombre'),
										A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Contraseña'),
										A2(
										$author$project$Signup$styledInput,
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('Crear mi cuenta')
											]))
									]))
							]))
					]))
